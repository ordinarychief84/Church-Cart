...
function Btn({ label }: { label: string }) {
  ...
  return (
    <button type="submit" disabled={pending} className="btn-secondary cp-btn-md w-full">
      <GoogleMark />
...
function GoogleMark() {
  return (
    <svg width="16" height="16" viewBox="0 0 18 18" aria-hidden="true">
      ...
      <path
        fill="#EA4335"
        d="M9 3.58c1.32 0 2.5.45 3.44 1.35l2.58-2.58A8.99 8.99 0 0 0 9 0 9 9 0 0 0 .92 4.95l3.05 2.33C4.68 5.16 6.66 3.58 9 3.58z"
      />
    </svg>
  );
}
